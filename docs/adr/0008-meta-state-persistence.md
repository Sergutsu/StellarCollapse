...
3. **Starter profile = P2 placeholders.** First boot is indistinguishable from the pre-persistence hub (credits = 4800, O₂ = 82%, fuel = 640, minerals = 1200, warp = 3, 3 starter ships at 100/78/92% hull, 3 starter crew). When P1 lands, mutations will start producing deltas.
